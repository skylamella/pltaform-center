...
public enum BizCodeEnum {
    ...
    SYSTEM_ERROR(110003, "系统错误，请稍后重试，或联系系统管理员。"),
    DATA_NOT_FOUND_ERROR(110004, "数据不存在或数据异常。"),

    /**
     * 短链分组
     */
    GROUP_REPEAT(230001, "分组名重复"),
    GROUP_OPER_FAIL(235003, "分组名操作失败"),
    GROUP_NOT_EXIST(234004, "分组不存在"),
    ...
    CODE_TYPE_ERROR(240004, "验证码类型不存在"),
    CODE_SEND_NUM_ERROR(240005, "验证码一天只能发送5次"),
